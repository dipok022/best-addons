...
class Best_Addons_Admin_Settings
{
	...
	public static function get_all_widgets_map()
	{
		return [
			...
			'best-accordion'     => esc_html__('Best Accordion', 'best-addons'),
		];
	}
...
?>
		<div class="wrap" style="background:#fff; padding:30px; border-radius:12px; margin-top:20px; max-width:800px; box-shadow:0 5px 15px rgba(0,0,0,0.05);">
			...
			<div>
				<h2 style="color:#1e293b;font-weight:700;margin-bottom:8px;">🛠️ <?php esc_html_e('Widget Builder', 'best-addons'); ?></h2>
				<p style="color:#64748b;font-size:14px;margin-bottom:16px;">
					<?php esc_html_e('Create your own custom Elementor widgets using HTML, CSS, JS and dynamic controls — no coding required.', 'best-addons'); ?>
				</p>
				<a
					href="<?php echo esc_url(admin_url('admin.php?page=ba-widget-builder')); ?>"
					class="button button-secondary"
					style="margin-right:8px;">
					📋 <?php esc_html_e('Manage Widgets', 'best-addons'); ?>
				</a>
				<a
					href="<?php echo esc_url(admin_url('admin.php?page=ba-widget-builder')); ?>"
					class="button button-primary"
					style="background:#e11d48;border:none;">
					＋ <?php esc_html_e('Create New Widget', 'best-addons'); ?>
				</a>
				</a>
				<a
					href="<?php echo esc_url(admin_url('post-new.php?post_type=best_widget')); ?>"
					class="button button-primary"
					style="background:#e11d48;border:none;">
					＋ <?php esc_html_e('Create New Widget', 'best-addons'); ?>
				</a>
