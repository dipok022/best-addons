...
class Best_Addons_Advanced_Accordion_Widget extends \Elementor\Widget_Base
{
	...
	{
		return 'best_addons_advanced_accordion';
	}
	...
	{
		return ['best-addons-style-advanced-accordion'];
	}
	public function get_script_depends()
	{
		return ['best-addons-script-advanced-accordion'];
	}
...
?>
		<div id="best-advanced-accordion" class="best-advanced-accordion">
