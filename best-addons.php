...
final class Best_Addons_Optimizer
{
	...
	public function __construct()
	{
		...
		// Widget Builder system — CPT + admin UI.
		$this->init_widget_builder();
	}

	private function init_widget_builder()
	{
		require_once(__DIR__ . '/includes/widget-builder/class-cpt.php');
		\Best_Addons_Widget_Builder_CPT::init();

		if (is_admin()) {
			require_once(__DIR__ . '/includes/widget-builder/class-admin-ui.php');
			\Best_Addons_Widget_Builder_Admin_UI::init();
		}
	}
	...
	public function init()
	{
		...
		// Widget Builder: register dynamic widgets from CPT posts.
		require_once(__DIR__ . '/includes/widget-builder/class-loader.php');
		\Best_Addons_Widget_Builder_Loader::init();
	}

	public function register_production_assets()
	{
		// Matches your explicit asset keys directly with the filenames output by Vite
		$widgets = ['sample-widget', 'advanced-accordion', "best-accordion"];
